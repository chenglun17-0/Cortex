...
export async function executeCLIWithJson(
  args: string[],
  timeout: number = 30000
): Promise<any> {
...
export async function startTask(taskId: number): Promise<any> {
...
export async function submitPr(commitMessage?: string): Promise<any> {
  const args = ["tasks", "pr"];
  if (commitMessage) {
...
export async function completeTask(): Promise<any> {
